  ...
  return (
    <div style={aboutContainer}>
      <header style={aboutHeader}>
        ...
        <h1 style={title}>About War Room</h1>
      </header>

      <main style={contentArea}>
        <section style={glassSection}>
          <div style={iconBox}><Zap color="#3ecf8e" size={32} /></div>
          <h3>High-Speed Collaboration</h3>
          <p>War Room is a real-time command center designed for hackathons and rapid development sprints. It synchronizes tasks, architecture diagrams, and team communications instantly across all members.</p>
        </section>

        <div style={grid}>
          <div style={smallCard}>
            <ShieldCheck color="#3ecf8e" size={24} />
            <h4>Secure</h4>
            <p>Powered by Supabase Row Level Security.</p>
          </div>
          <div style={smallCard}>
            <Info color="#3ecf8e" size={24} />
            <h4>Version</h4>
        ...
        <footer style={footer}>
          ...
          <div style={divider} />
          <button style={gitBtn} onClick={() => window.open('https://github.com/shishir-sh26/H-TeamState', '_blank')}>
